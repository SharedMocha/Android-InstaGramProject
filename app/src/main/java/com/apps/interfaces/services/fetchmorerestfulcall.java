 ...
 */
public class fetchmorerestfulcall {
    ...
    public final void  getdata(final Context context,final restfuladapter adapter,final ArrayList<instagramdetails> details,String nexturl,final SwipeRefreshLayout swipeRefreshLayout)
    {
        ...
        connectionclient.get(nexturl, new JsonHttpResponseHandler() {
            @Override
